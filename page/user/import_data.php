<style>
	...
	<div style="padding: 0 15px;">
		...
		<form method="post" action="" enctype="multipart/form-data">
			<a href="assets/data_user_cekberkasta.xlsx" class="btn btn-primary">
			...
			if($ext == "xlsx"){
				...
				foreach($sheet as $row){ // Lakukan perulangan dari data yang ada di excel
					...
					if($numrow > 1){
							...
							$hp_td =  ( ! empty($hp))? "" : " style='background: #E07171;'";
							$usr_td =  ( ! empty($usr))? "" : " style='background: #E07171;'";
							$psw_td =  ( ! empty($psw))? "" : " style='background: #E07171;'";
							$lvl_td =  ( ! empty($lvl))? "" : " style='background: #E07171;'";

							

							// Jika salah satu data ada yang kosong
							if($id == "" or $nm == "" or $hp == "" or $usr == "" or $psw == "" or $lvl == "")
                ...
                <button type="submit" name='submit' id="submit" value="submit"  class="btn btn-danger"><span class='glyphicon glyphicon-upload'> Import</button>			
				<?php  
                echo "</form>";
